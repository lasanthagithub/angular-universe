export default class RefData {
  ...
  static countries = [
    ...
    { country: 'Algeria', continent: 'Africa', language: 'Arabic' },
    { country: 'Egypt', continent: 'Africa', language: 'Arabic' },
    { country: 'Morocco', continent: 'Africa', language: 'Arabic' },
    { country: 'Tunisia', continent: 'Africa', language: 'Arabic' },
    { country: 'Angola', continent: 'Africa', language: '(other)' },
    { country: 'Niger', continent: 'Africa', language: '(other)' },
    { country: 'South Africa', continent: 'Africa', language: '(other)' },
    { country: 'Qatar', continent: 'Asia', language: 'Arabic' },
    { country: 'UAE', continent: 'Asia', language: 'Arabic' },
    { country: 'Qatar', continent: 'Asia', language: 'Arabic' },
    { country: 'Lebanon', continent: 'Asia', language: 'Arabic' },
    { country: 'Bahrain', continent: 'Asia', language: 'Arabic' },
